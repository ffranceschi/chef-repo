...
default['java']['ubuntuarch'] = kernel['machine'] =~ /x86_64/ ? "amd64" : "i586"
...
when "ubuntu"
  case platform_version
    when "12.04"
    default['java']['java_home'] = "/usr/lib/jvm/java-#{java['jdk_version']}-#{java['install_flavor']}-#{java['ubuntuarch']}"
    else
    default['java']['java_home'] = "/usr/lib/jvm/java-#{java['jdk_version']}-#{java['install_flavor']}"
  end
else
